<template>
  <v-card class="mr-3" elevation="12">
    <v-navigation-drawer flat floating permanent>
      <v-list dense>
        <v-list-item-group color="primary">
          <v-list-item v-for="item in items" :key="item.title" :to="item.route">
            ...
            <v-list-item-content>
              <v-list-item-title class="font-weight-light primary--text">{{ item.title }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list-item-group>
      </v-list>
...
export default {
  data: () => ({
    items: [
      ...
      { title: "Analytics", icon: "fa-chart-pie", route: "/Analytics" },
